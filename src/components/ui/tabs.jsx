  ...
  return (
    <TabsPrimitive.Trigger
      ...
      className={cn(
        ...
        "bg-transparent text-black hover:bg-secondary/80 hover:text-black",
        "data-[state=active]:bg-secondary data-[state=active]:text-black data-[state=active]:shadow-sm data-[state=active]:border-black",
